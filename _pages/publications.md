...
- **[Ontolearn---A Framework for Large-scale OWL Class Expression Learning in Python](https://doi.org/10.48550/arXiv.2510.11561)**  
...
- **[Resilience in Knowledge Graph Embeddings](https://doi.org/10.4230/TGDK.3.2.1)**  
...
- **[Dung’s Argumentation Framework: Unveiling the Expressive Power with Inconsistent Databases](https://doi.org/10.1609/aaai.v39i14.33651)**  
  Yasir Mahmood, Markus Hecher, Axel-Cyrille Ngonga Ngomo  
  *Proceedings of the AAAI Conference on Artificial Intelligence*  

- **[Facets in Argumentation: A Formal Approach to Argument Significance](https://doi.org/10.24963/ijcai.2025/500)**  
...
- **[Prompting LLMs for the Run-Time Event Calculus](https://doi.org/10.4230/LIPIcs.TIME.2025.16)**  
...
- **[Sound and Complete Neurosymbolic Reasoning with LLM-Grounded Interpretations](https://doi.org/10.48550/arXiv.2507.09751)**  
...
- **[Parameterized complexity of weighted team definability](https://doi.org/10.1017/S0960129524000033)**  
...
- **[Blink: Blank Node Matching Using Embeddings](https://doi.org/10.1007/978-3-031-77844-5_12)**  
  Alexander Becker, Mohamed Ahmed Sherif, Axel-Cyrille Ngonga Ngomo  
  *Lecture Notes in Computer Science, The Semantic Web – ISWC 2024*  

- **[CYCLE: Cross-Year Contrastive Learning in Entity-Linking](https://doi.org/10.1145/3627673.3679702)**  
...
- **[Detecting and Fixing Inconsistency of Large Knowledge Graphs](https://doi.org/10.1145/3688671.3688766)**  
  Charilaos Akasiadis, Anastasios Nentidis, Angelos Charalambidis, Alexander Artikis  
  *Proceedings of the 13th Hellenic Conference on Artificial Intelligence*  

- **[Embedding Knowledge Graphs in Degenerate Clifford Algebras](https://doi.org/10.48550/arxiv.2402.04870)**  
  Kamdem Teyou, Louis Mozart; Demir, Caglar; Ngonga Ngomo, Axel-Cyrille  
  *Frontiers in Artificial Intelligence and Applications*  

- **[Enhancing Answers Verbalization Using Large Language Models](https://doi.org/10.3233/SSW240027)**  
  Daniel Vollmers, Parth Sharma, Hamada M. Zahera, Axel-Cyrille Ngonga-Ngomo  
  *Studies on the Semantic Web, Knowledge Graphs in the Age of Language Models and Neuro-Symbolic AI*  

- **[Error Analysis of Multilingual Language Models in Machine Translation: A Case Study of English-Amharic Translation](https://doi.org/10.18653/v1/2024.emnlp-main.1102)**  
  Hizkiel Mitiku Alemayehu, Hamada M Zahera, Axel-Cyrille Ngonga Ngomo  
  *Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing*  

- **[Evaluating Negation with Multi-way Joins Accelerates Class Expression Learning](https://doi.org/10.1007/978-3-031-70365-2_12)**  
  Nikolaos Karalis, Alexander Bigerl, Caglar Demir, Liss Heidrich, Axel-Cyrille Ngonga Ngomo  
  *ECML PKDD 2024*  

- **[Generating SPARQL from Natural Language Using Chain-of-Thoughts Prompting](https://doi.org/10.3233/SSW240028)**  
  Hamada M. Zahera, Manzoor Ali, Mohamed Ahmed Sherif, Diego Moussallem, Axel-Cyrille Ngonga Ngomo  
  *Studies on the Semantic Web, Knowledge Graphs in the Age of Language Models and Neuro-Symbolic AI*  

- **[Quantitative Claim-Centric Reasoning in Logic-Based Argumentation](https://doi.org/10.24963/ijcai.2024/377)**  
...
- **[ROCES: Robust Class Expression Synthesis in Description Logics via Iterative Sampling](https://doi.org/10.24963/ijcai.2024/479)**  
  N'Dah Jean Kouagou, Stefan Heindorf, Caglar Demir, Axel-Cyrille Ngonga Ngomo  
  *Proceedings of the Thirty-ThirdInternational Joint Conference on Artificial Intelligence*  

- **[Rejection in Abstract Argumentation: Harder Than Acceptance?](https://doi.org/10.3233/FAIA240867)**  
  Johannes K. Fichte, Markus Hecher, Yasir Mahmood, Arne Meier  
  *Frontiers in Artificial Intelligence and Applications, ECAI 2024*  

- **[SHROOM-INDElab at SemEval-2024 Task 6: Zero- and Few-Shot LLM-Based Classification for Hallucination Detection](https://doi.org/10.18653/v1/2024.semeval-1.120)**  
  Bradley Allen, Fina Polat, Paul Groth  
  *Proceedings of the 18th International Workshop on Semantic Evaluation (SemEval-2024)*  

- **[TIGER: Temporally Improved Graph Entity Linker](https://doi.org/10.3233/FAIA240933)**  
...
- **[Data journeys: Explaining AI workflows through abstraction](https://doi.org/10.3233/SW-233407)**  
  Enrico Daga, Paul Groth  
  *Semantic Web*  

- **[Evaluating FAIR Digital Object and Linked Data as distributed object systems](https://doi.org/10.48550/arxiv.2306.07436)**  
  Stian Soiland-Reyes; Carole Goble; Paul Groth  
  *PeerJ Computer Science*  

- **[Knowledge Engineering Using Large Language Models](https://doi.org/10.4230/TGDK.1.1.3)**  
  Bradley P. Allen, Lise Stork, Paul Groth  
  *Transactions on Graph Data and Knowledge (TGDK)*  

- **[NELLIE: Never-Ending Linking for Linked Open Data](https://doi.org/10.1109/ACCESS.2023.3300694)**  
  Abdullah Fathi Ahmed, Mohamed Ahmed Sherif, Axel-Cyrille Ngonga Ngomo  
  *IEEE Access*, 11  

- **[Online event recognition over noisy data streams](https://doi.org/10.1016/j.ijar.2023.108993)**  
  Periklis Mantenoglou, Alexander Artikis, Georgios Paliouras  
  *International Journal of Approximate Reasoning*, 161  

### Conference and Workshop Papers

- **[ANTS: Abstractive Entity Summarization in Knowledge Graphs](https://doi.org/10.1007/978-3-031-94575-5_8)**  
...
- **[An Event Calculus for Run-Time Reasoning](https://doi.org/10.4230/LIPIcs.TIME.2023.14)**  
  Periklis Mantenoglou  
  *30th International Symposium on Temporal Representation and Reasoning (TIME 2023)*  

- **[AutoCL: AutoML for Concept Learning](https://doi.org/10.1007/978-3-031-63787-2_7)**  
  Jiayi Li, Sheetal Satheesh, Stefan Heindorf, Diego Moussallem, René Speck, Axel-Cyrille Ngonga Ngomo  
  *Communications in Computer and Information Science, Explainable Artificial Intelligence*  

- **[COBALT: A Content-Based Similarity Approach for Link Discovery over Geospatial Knowledge Graphs](https://doi.org/10.3233/SSW230013)**  
  Alexander Becker, Abdullah Ahmed, Mohamed Ahmed Sherif, Axel-Cyrille Ngonga Ngomo  
  *Studies on the Semantic Web, Knowledge Graphs: Semantics, Machine Learning, and Languages*  

- **[Clifford Embeddings – A Generalized Approach for Embedding in Normed Algebras](https://doi.org/10.1007/978-3-031-43418-1_34)**  
...
- **[Do Instruction-tuned Large Language Models Help with Relation Extraction?](https://ceur-ws.org/Vol-3577/paper15.pdf)**  
  ...
  *Joint proceedings of the KBC-LM workshop and the LM-KBC challenge at ISWC 2023*  
...
- **[Explainable Integration of Knowledge Graphs using Large Language Models](https://doi.org/10.1007/978-3-031-35320-8_9)**  
...
- **[Improving Graph-to-Text Generation Using Cycle Training](https://aclanthology.org/2023.ldk-1.24)**  
  Fina Polat, Ilaria Tiddi, Paul Groth, Piek Vossen  
  *Proceedings of the 4th Conference on Language, Data and Knowledge*  

- **[IndEL: Indonesian Entity Linking Benchmark Dataset for General and Specific Domains](https://doi.org/10.1007/978-3-031-70239-6_34)**  
  Ria Hari Gusmita, Muhammad Faruq Amiral Abshar, Diego Moussallem, Axel-Cyrille Ngonga Ngomo  
  *Lecture Notes in Computer Science, Natural Language Processing and Information Systems*  

- **[Knowledge-centric Prompt Composition for Knowledge Base Construction from Pre-trained Language Models](https://ceur-ws.org/Vol-3577/paper3.pdf)**  
  Xue Li, Anthony James Hughes, Majlinda Llugiqi, Fina Polat, Paul Groth, Fajar J. Ekaputra  
  *Joint proceedings of the KBC-LM workshop and the LM-KBC challenge at ISWC 2023*  

- **[Learning Permutation-Invariant Embeddings for Description Logic Concepts](https://doi.org/10.1007/978-3-031-30047-9_9)**  
  Caglar Demir, Axel-Cyrille Ngonga Ngomo  
  *Advances in Intelligent Data Analysis XXI. Lecture Notes in Computer Science.*  

- **[Logics with probabilistic team semantics and the Boolean negation](https://doi.org/10.1007/978-3-031-43619-2_45)**  
  Miika Hannula, Minna Hirvonen, Juha Kontinen, Yasir Mahmood, Arne Meier, Jonni Virtema  

- **[Native Execution of GraphQL Queries over RDF Graphs Using Multi-way Joins](https://doi.org/10.3233/SSW230007)**  
...
- **[Neuro-Symbolic Class Expression Learning](https://doi.org/10.24963/ijcai.2023/403)**  
  Caglar Demir, Axel-Cyrille Ngonga Ngomo  

- **[Parameterized Complexity of Propositional Inclusion and Independence Logic](https://doi.org/10.1007/978-3-031-39784-4_17)**  
  Yasir Mahmood, Jonni Virtema  

- **[Quantitative Reasoning and Structural Complexity for Claim-Centric Argumentation](https://doi.org/10.24963/ijcai.2023/358)**  
  Johannes K. Fichte, Markus Hecher, Yasir Mahmood, Arne Meier  

- **[TemporalFC: A Temporal Fact Checking approach over Knowledge Graphs](https://doi.org/10.1007/978-3-031-47240-4_25)**  
  Umair Qudus, Michael Röder, Sabrina Kirrane, Axel-Cyrille Ngonga Ngomo  

- **[UniQ-Gen: Unified Query Generation Across Multiple Knowledge Graphs](https://doi.org/10.1007/978-3-031-77792-9_11)**  
